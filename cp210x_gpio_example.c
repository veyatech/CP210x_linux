...
int main()
{
	...
	unsigned short gpio = 0x0003;
#endif

// HELP: 0x0003 Lower byte i.e. 03 tells the 0b0000-0011 bits to update
// 		upper byte i.e. tells that the value will be 00 of the selected bytes
